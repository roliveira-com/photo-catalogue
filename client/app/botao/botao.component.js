...
var BotaoComponent = (function () {
    function BotaoComponent() {
        ...
        this.tipo = 'button';
        this.disable = false;
        this.comando = new core_1.EventEmitter();
    }
    BotaoComponent.prototype.execute = function () {
        if (this.confirmacao) {
    ...
    ], BotaoComponent.prototype, "disable", void 0);
    __decorate([
        core_1.Output(), 
        __metadata('design:type', Object)
    ], BotaoComponent.prototype, "comando", void 0);
    __decorate([
        core_1.Input(), 
        __metadata('design:type', Boolean)
